...
CLASS lcl_flights DEFINITION.
  ...
  PRIVATE SECTION.
    ...
    DATA standard_table TYPE STANDARD TABLE OF zrrs_02_flight WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
    DATA sorted_table TYPE SORTED TABLE OF zrrs_02_flight WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
    DATA hashed_table TYPE HASHED TABLE OF zrrs_02_flight WITH UNIQUE KEY carrier_id connection_id flight_date.
...
CLASS lcl_flights IMPLEMENTATION.
  ...
  METHOD constructor.
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    SELECT FROM zrrs_02_flight FIELDS * INTO TABLE @standard_table.
    SELECT FROM zrrs_02_flight FIELDS * INTO TABLE @sorted_table.
    SELECT FROM zrrs_02_flight FIELDS * INTO TABLE @hashed_table.

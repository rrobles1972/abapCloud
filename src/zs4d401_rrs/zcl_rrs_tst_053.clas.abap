CLASS zcl_rrs_tst_053 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rrs_tst_053 IMPLEMENTATION.
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" RRS 12.12.2025 - There is not valid conversion rates to unit 'EUR'.
" TCURR / TCURF / TCURV / TCURX / TCURC ... << Without authorization
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
*    SELECT FROM /dmo/travel
*         FIELDS total_price,
*                currency_code,

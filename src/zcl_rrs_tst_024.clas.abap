CLASS zcl_rrs_tst_024 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RRS_TST_024 IMPLEMENTATION.
...
*    Example 1: Corresponding between FIELDS and INTO
**********************************************************************
...
**********************************************************************
    ...
    SELECT SINGLE
      ...
      LEFT OUTER JOIN /dmo/airport AS f ON c~airport_from_id = f~airport_id )
      LEFT OUTER JOIN /dmo/airport AS t ON c~airport_to_id   = t~airport_id
